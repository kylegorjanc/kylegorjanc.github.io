...
// Player1 = new Player('Pinkie Pie', 'images/pinkiechip.png', 1);
// Player2 = new Player('Rainbow Dash', 'images/rainbowchip.png', 2);
// Player3 = new Player('FlutterShy', 'images/flutterchip.png', 3);
// Player4 = new Player('Twilight Sparkle', 'images/flutterchip.png', 4);
// currentPlayer = Player1;
// // {
// // 	this.name = 'Pinkie Pie',
// // 	this.chipImg = '../images/pinkiechip.png'
...
// 	this.currentPlayer = Player1;
// };
// Board.prototype.getPlayableCells = function(){
// for (i = 0; i < $('.jColumn').length; i++)
// 	Board.prototype.getLowest0 = function() {
// 		var playableCells = [];
// 		for (i = 0; i < $('.jCells').length; i++) {
// 			while (i === 0) {
// 				playableCells.push($('.jCells').indexOf(i));
// 			}
// 		}
// 		Array.min = function(playableCells) {
// 			var x =  Math.min.apply(Math, playableCells);
// 			Column.prototype.cellInPlay = 
// 		}
// 	}
// };
// Board.prototype.dropChip = function() {
